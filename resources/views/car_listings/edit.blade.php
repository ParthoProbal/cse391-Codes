            ...
            <div class="col-lg-8">
                ...
                <div class="card bg-black border-secondary">
                    ...
                    <div class="card-body p-4">
                        ...
                        <form
                            action="{{ route('car_listings.update', $carListing) }}"
                            method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <select
                                    ...
                                    <option
                                        value="{{ $brand->id }}"
                                        {{ $carListing->brand_id == $brand->id ? 'selected' : '' }}>
                            ...
                            <div class="mb-3">
                                ...
                                <select
                                    ...
                                    <option
                                        value="{{ $city->id }}"
                                        {{ $carListing->city_id == $city->id ? 'selected' : '' }}>
